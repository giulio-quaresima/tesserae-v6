...
import v3BlogPosts from '../../data/v3_blog_posts.json';
            ...
            {v3BlogPosts.map((post, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-5 py-4 flex items-center justify-between bg-gray-50 hover:bg-red-50 text-left transition-colors focus:outline-none"
                >
                  <div className="pr-4">
                  ...
                  <svg
                    className={`w-5 h-5 text-gray-400 transition-transform duration-200 ${expandedPost === index ? 'rotate-180' : ''}`}
