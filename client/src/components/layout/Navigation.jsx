          ...
          <div className="flex overflow-x-auto scrollbar-hide -mx-3 px-3 sm:mx-0 sm:px-0">
            {mainTabs.map(tab => (
              <button
                ...
                className={`px-2 sm:px-4 py-2 sm:py-3 font-medium text-xs sm:text-sm border-b-2 whitespace-nowrap ${pageType === tab.code
            ...
            {showDownloads && setShowDownloads && (
              <button
                ...
                className={`px-2 sm:px-4 py-2 sm:py-3 font-medium text-xs sm:text-sm border-b-2 whitespace-nowrap hidden sm:block ${pageType === 'downloads'
                    ? 'border-red-700 text-red-700'
                    : 'border-transparent text-gray-500 hover:text-red-600'
                  }`}
              >
            ...
            <div className="flex overflow-x-auto scrollbar-hide -mx-3 px-3 sm:mx-0 sm:px-0">
              {languageTabs.map(tab => (
                <button
                  ...
                  className={`px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium rounded-t whitespace-nowrap ${activeTab === tab.code
