...
An edge case of particular difficulty was when multiple hyphens were next to each other, as in “Deception innocent–give ample space” (Cowper Task 1.353). The version 3 algorithm handles this case easily because it will find “innocent” as a word, then decide that ‘–’ is a non-word, and find “give” as a word. In an earlier attempt at constructing an effective non-word-matcher for version 5, the algorithm would mistakenly parse “innocent–give” as one token. The solution was to add the multiple hyphen case explicitly as a non-word sequence.`,images:[],author:"Jeffery Kinnison"},{title:"Tesserae Version 5 Local Installation Instructions",date:"February 13, 2021",url:"https://web.archive.org/web/20240908124300/https://tesserae.caset.buffalo.edu/blog/tesserae-version-5-local-installation-instructions/",content:`As long as the standalone version is unavailable, this document will guide the brave in installing the software necessary to run Tesserae on their own machines. Even after the standalone version becomes available, these instructions should shed light on the assumptions upon which the standalone version was built.
...
From excerpts of Homer’s Iliad and Plato’s Gorgias :`,images:["https://web.archive.org/web/20240908124300im_/http://tesserae.caset.buffalo.edu/blog/wp-content/uploads/2020/12/Picture2.png","https://web.archive.org/web/20240908124300im_/http://tesserae.caset.buffalo.edu/blog/wp-content/uploads/2020/12/Picture1.png"],author:"Jeffery Kinnison"},{title:"Estimating the Size of the Corpus",date:"December 11, 2020",url:"https://web.archive.org/web/20240908124300/https://tesserae.caset.buffalo.edu/blog/estimating-the-size-of-the-corpus/",content:`We recently had the opportunity to assess where our corpus stands and thought it could be useful for users to know its aggregate numbers. A convenient point of comparison is the largest publication environment for open source texts in Greek and Latin: the Scaife Viewer, which includes Open Greek and Latin texts and all CTS-compliant texts from the Perseus Digital Library.
...
https://www.academia.edu/30489187/Measuring_Literary_Influence_at_Scale_with_Tesseraes_Multitext_Capability`,images:[],author:"James O. Gawley and A. Caitlin Diddams"},{title:"New Publication on Intertextuality",date:"October 1, 2019",url:"https://web.archive.org/web/20240908124300/https://tesserae.caset.buffalo.edu/blog/new-publication-on-intertextuality/",content:`Walter Scheirer and Chris Forstall, Tesserae team members, have recently published a new text: Quantitative Intertextuality: Analyzing the Markers of Information Reuse .  The text covers a new method of studying intertextuality through the use of a diverse array of computational and quantitative tools.  For more information and to get the text follow this link:

https://www.amazon.com/dp/B07V72C5YZ/ref=cm_sw_r_cp_api_i_P.bJDbFPW0SNV`,images:[],author:"Tesserae Project Team"}];export{e as default};
